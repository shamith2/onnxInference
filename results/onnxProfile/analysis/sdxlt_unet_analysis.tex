...
\centering
\includegraphics[width=\textwidth]{sdxl_turbo_unet_analysis_optimization1}
\end{figure}
...
\centering
\includegraphics[width=\textwidth]{sdxl_turbo_unet_fp32_512x512_4mb_pie_plot}
\end{figure}
...
\centering
\includegraphics[width=\textwidth, angle=270]{sdxl_turbo_unet_fp32_512x512_4mb_operators_plot}
\end{figure}
