...
class Attention(nn.Module):
    ...
    def forward(
        ...
        # torch.save(scores, os.path.join(save_dir, 'scores_mask_off.pt'))
...
class FeedForward(nn.Module):
    def __init__(
        ...
        # torch.save(self.w1, os.path.join(save_dir, 'w1_off.pt'))
        # torch.save(self.w2, os.path.join(save_dir, 'w2_off.pt'))
        # torch.save(self.w3, os.path.join(save_dir, 'w3_off.pt'))
