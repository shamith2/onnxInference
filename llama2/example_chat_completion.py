...
def main(
    ckpt_dir: str = os.path.join(os.getcwd(), 'llama', 'llama-2-7b-chat'),
    tokenizer_path: str = os.path.join(os.getcwd(), 'ai.architecture', 'genAI', 'llama2', 'llama2-7b-chat', 'tokenizer.model'),
